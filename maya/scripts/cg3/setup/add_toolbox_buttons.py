...
from cg3.ui import maya_gui


def win_manager_factory():
    from cg3.ui import windows
    windows.WindowManager()

def module_manager_factory():
    from cg3.util.devtools import ModuleManager
    ModuleManager()

def attribute_finder_factory():
    from cg3.util.pminspect import AttributeFinder
    AttributeFinder()

def test_runner_factory():
    import cg3.test.mayaunittestui as mayatestui
    mayatestui.show()
...
btn = maya_gui.add_toolbox_button(
    command=pc.Callback(pc.warning, "Not implemented ATM. Right Click to see Developer Tools."),
    style="iconOnly",
    i="hdm.png"
)
