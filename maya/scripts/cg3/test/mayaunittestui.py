...
import cg3.test.mayaunittest as mayaunittest
import cg3.util.shortcuts as shortcuts
from cg3.ui.widgets import OutputConsole

logger = logging.getLogger(__name__)

ICON_DIR = os.path.normpath(os.path.join(getenv("CG3_ICONS_DIR"), "cmt"))
