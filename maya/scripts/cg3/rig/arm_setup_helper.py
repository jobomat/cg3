...
from cg3.rig.joints import joint_chain_replicator
from cg3.rig.utils import create_pairblend
from cg3.rig.icons import import_blendshaped_ik_fk
...
replica_groups = joint_chain_replicator(joint_chain, name, "_bnd", ["_ik", "_fk", "_result"])
